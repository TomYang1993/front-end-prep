...
import { DIFFICULTY_LABEL, DIFFICULTY_TEXT_CLASS } from '@/types/domain';
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="meta-row">
            ...
            <span className={clsx('font-semibold', DIFFICULTY_TEXT_CLASS[props.difficulty.toUpperCase()])}>{DIFFICULTY_LABEL[props.difficulty] ?? props.difficulty}</span>
